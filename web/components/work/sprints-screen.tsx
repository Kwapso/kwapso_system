 ...
 *
 * EXPORTED FROM THERE (2026-09-15, the Waves T3 timeline) — `web/components/
 * records/record-timeline.tsx` tones a wave's own sprint-segments by the
 * identical three states rather than re-deriving them: the same seam every
 * other reader of a sprint's state already goes through (`work-panels.tsx`,
 * `type-marks.ts`), never a second copy of the running/upcoming/wrapped
 * arithmetic.
 *
