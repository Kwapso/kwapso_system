...
//   · web/components/records/record-chrome.tsx      the thirteen bespoke details
//   · web/components/deep-link/module-content.tsx  the recipe-driven ones
// and nowhere else.
//
// ── WHAT IS BEHIND THE DOOR IS `<ActivityPanel>`, UNCHANGED ─────────────────
//
// web/components/records/activity-panel.tsx was the body of the Activity TAB on every
