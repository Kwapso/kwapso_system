...
import { GoogleScopeDialog } from "@/components/knowledge/google-scope-dialog"
import { GoogleSourceDialog } from "@/components/knowledge/google-source-dialog"
      ...
      {q.data?.ready && connections.length > 0 && can("knowledge", "create") && can("google", "read") && (
        <div className="flex flex-col gap-2 rounded-[var(--radius)] bg-surface-panel p-3">
          <div className="flex flex-wrap items-center justify-between gap-2">
             ...
             * had one — see components/knowledge/google-sync.tsx. Both halves, because
