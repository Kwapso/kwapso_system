...
export const SECTION_HOSTED_ELSEWHERE: Record<string, string> = {
  ...
  roles:
    "Settings › Team, the roles matrix (web/components/team/roles-matrix.tsx) — every role's rights at once, the client's own \"All the roles together, I want to have an overview\"; a role is a COLUMN since 2026-09-10 (\"would it not make more sense taht the roles are the cokumns and the permissions the rows\"), and pressing its column head opens the role's slide-in, where it is edited and switched on or off. The retired roles LIST screen's \"Export CSV\" download (the one act that had no other home when that screen went, 2026-09-14) moved onto this same header, beside \"New role\".",
  invites:
