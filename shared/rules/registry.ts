...
export const SECTION_HOSTED_ELSEWHERE: Record<string, string> = {
  members:
    "Settings › Team, the members gallery (web/components/team/members-gallery.tsx). A card press opens that person's slide-in, where their role is changed and they are removed from the team.",
  roles:
    "Settings › Team, the roles matrix (web/components/team/roles-matrix.tsx) — every role's rights at once, the client's own \"All the roles together, I want to have an overview\"; a row press opens the role's slide-in, where it is edited and switched on or off.",
  invites:
