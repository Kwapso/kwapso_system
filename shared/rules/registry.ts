...
export const NO_NESTED_SCROLL_EXEMPT: Record<string, string> = {
  ...
  "web/components/meetings/meeting-detail.tsx#max-h-96 overflow-y-auto rounded-[var(--radius)] bg-surface-panel p-3":
    "SANCTIONED, Aurora's ruling \"confirm\", 21 Sep 2026, over the recommendation \"keep. A transcript flowing into the page would bury everything else on the record.\" The meeting transcript preview.",
}
